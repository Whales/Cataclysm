...
PF_WINGS_BIRD, PF_COLDBLOOD, NULL);
  break;
...
PF_TAIL_FIN, PF_DEFORMED, PF_THIRST, PF_WEBBED, PF_SLIMY, PF_COLDBLOOD2, NULL);
 ...
 case MUTCAT_BEAST:
  setvector(ret,
PF_TOUGH, PF_DEFT, PF_ANIMALEMPATH, PF_TERRIFYING, PF_ADRENALINE, PF_MYOPIC,
PF_FORGETFUL, PF_NIGHTVISION2, PF_FANGS, PF_FUR, PF_CLAWS, PF_PHEROMONE_MAMMAL,
PF_PADDED_FEET, PF_TAIL_FLUFFY, PF_SMELLY2, PF_DEFORMED2, PF_HUNGER, PF_TROGLO,
PF_CARNIVORE, PF_SNARL, PF_SHOUT3, PF_CANINE_EARS, NULL);
  break;
...
PF_COMPOUND_EYES, PF_ANTENNAE, PF_WINGS_INSECT, PF_TAIL_STING, PF_MANDIBLES,
PF_DEFORMED, PF_TROGLO, PF_COLDBLOOD3, NULL);
  break;

 case MUTCAT_PLANT:
  setvector(ret,
PF_DISIMMUNE, PF_HEAVYSLEEPER, PF_BADHEARING, PF_FASTHEALER2, PF_BARK,
PF_THORNS, PF_LEAVES, PF_DEFORMED2, PF_PONDEROUS3, NULL);
  break;
...
PF_WEBBED, PF_UNSTABLE, PF_RADIOACTIVE1, PF_SLIMY, NULL);
  break;
...
PF_CARNIVORE, PF_COLDBLOOD, NULL);
  break;
