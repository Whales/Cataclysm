...
{   // name        sym   color    sym_b   color_b  dmg  dur  par1 par2  item
    ...
    { "blade",      '-', c_white,   'x', c_white,   250, 100, 0, 0, itm_machete, 3,
        mfb(vpf_external) | mfb(vpf_unmount_on_damage) | mfb(vpf_sharp) | mfb(vpf_no_reinforce) },
    { "blade",      '|', c_white,   'x', c_white,   350, 100, 0, 0, itm_machete, 3,
        mfb(vpf_external) | mfb(vpf_unmount_on_damage) | mfb(vpf_sharp) | mfb(vpf_no_reinforce) },
...
//                                                           size
    ...
    { "wheel",      'o', c_dkgray,  'x', c_ltgray,  50,  200, 10, 0, itm_wheel, 2,
        mfb(vpf_external) | mfb (vpf_mount_over) | mfb(vpf_wheel) | mfb(vpf_mount_point) },
//                                                                         power type
    { "1L combustion engine",       '*', c_ltred,  '#', c_red,     80, 200, 120, AT_GAS, itm_combustion_small, 3,
        mfb(vpf_internal) | mfb(vpf_engine) },
    { "2.5L combustion engine",     '*', c_ltred,  '#', c_red,     80, 300, 300, AT_GAS, itm_combustion, 4,
        mfb(vpf_internal) | mfb(vpf_engine) },
    { "6L combustion engine",       '*', c_ltred,  '#', c_red,     80, 400, 800, AT_GAS, itm_combustion_large, 5,
        mfb(vpf_internal) | mfb(vpf_engine) },
    ...
    { "large electric motor",       '*', c_yellow,  '#', c_red,    80, 400, 350, AT_BATT, itm_motor_large, 4,
        mfb(vpf_internal) | mfb(vpf_engine) },
    { "plasma engine",              '*', c_ltblue,  '#', c_red,    80, 250, 400, AT_PLASMA, itm_plasma_engine, 8,
        mfb(vpf_internal) | mfb(vpf_engine) },
//                                                                         capacity type
...
//                                                          bonus
    ...
    { "superalloy plating",')', c_dkgray, ')', c_dkgray, 100, 900, 0, 0, itm_alloy_plate, 5,
        mfb(vpf_internal) | mfb(vpf_armor) },
    { "spiked plating",    ')', c_red,    ')', c_red,    150, 900, 0, 0, itm_spiked_plate, 3,
        mfb(vpf_internal) | mfb(vpf_armor) | mfb(vpf_sharp) },
    { "hard plating",      ')', c_cyan,   ')', c_cyan,   100, 2300, 0, 0, itm_hard_plate, 5,
        mfb(vpf_internal) | mfb(vpf_armor) }
};
